...
myApp.controller('editBlogController',['$http','$routeParams','$location', 'blogService', function($http,$routeParams,$location, blogService) {
  ...
  this.getCurrentPost = function(){
     ...
     blogService.editCurrentBlog(this.blogId)
  ...
  this.editPost = function(blogId){
      ...
      blogService.editBlog(blogId, myData)
      .then(function successCallback(response) {
          // this callback will be called asynchronously
          // when the response is available
          //console.log(response);
